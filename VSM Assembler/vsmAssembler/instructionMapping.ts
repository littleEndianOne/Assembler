//Enum of arg types the can be used in instructions.
...
//Interface for defining an instruction.
export interface IInstructionDef {
    opcode: number;
    arguments: argTypes[];
}

//Interface for creating the instruction lookup table.
export interface IInstructionLookup {
    [index: string]: IInstructionDef; //Location of lable in machine code
}

//Instruction definitions.
export let instructionLookupTable: IInstructionLookup = {
